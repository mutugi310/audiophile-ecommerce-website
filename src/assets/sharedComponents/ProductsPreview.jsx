...
import speakerImg from '../imgs/speakerPreview.png'
import earphoneImg from '../imgs/earphonePreview.png'
  ...
  return (
    <section className='my-[4rem] pt-[4rem] w-full'>
      <div className='container m-auto flex flex-wrap flex-col gap-[4rem] p-4 align-middle justify-center sm:gap-4 sm:justify-between sm:flex-row lg:px-10  '>
        ...
        <div className='bg-pGray flex flex-col items-center pb-4 sm:w-[30%] '>
          <img src={speakerImg} alt="headphone image" className='max-w-none w-32 -mt-[4rem]'/>
        ...
        <div className='bg-pGray flex flex-col items-center pb-4 sm:w-[30%]'>
          <img src={earphoneImg} alt="headphone image" className='max-w-none w-32 -mt-[3.5rem]'/>
          <p className="font-bold pt-5">Earphone</p>
